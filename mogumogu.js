...
const performSpin = async (email, name, address, cookieHeader) => {
  try {
    ...
    const startRes = await axios.get('https://f2bf-2401-4900-1c72-3409-48c3-8702-82c8-6e25.ngrok-free.app/turnstile?url=https%3A%2F%2Fwww.mogumogu.com%2Fspin-wheel%2Fplay&sitekey=0x4AAAAAABdJseUK3fpyoPL2');
    ...
    for (let i = 237; i < 10000; i++) {
      await delay(1000);
      const resultRes = await axios.get(`https://f2bf-2401-4900-1c72-3409-48c3-8702-82c8-6e25.ngrok-free.app/result?id=${taskId}`);
